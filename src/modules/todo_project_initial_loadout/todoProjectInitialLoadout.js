...
function loadInitialTodoProjects() {
  if (localStorage.getItem('todoProjects') === null) {
    ...
    createTodoProject('Food to make');

    createTodoProject('Games to play');
    ...
    createTodoTask(
      getOrSetTodoProjects().getCurrentTodoProjects()[0].projectTitle,
    ...
    createTodoTask(
      getOrSetTodoProjects().getCurrentTodoProjects()[1].projectTitle,
      getOrSetTodoProjects().getCurrentTodoProjects(),
      'Crash Bandicoot 1',
